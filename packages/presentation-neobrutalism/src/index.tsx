  ...
  return (
    <WrapIfAdditionalTemplate {...props}>
      {props.displayLabel && !isCheckbox && (
        <label className="a-form-neobrutalism-label" htmlFor={props.id}>
          {props.label}
          {props.required ? <span className="a-form-neobrutalism-required"> *</span> : null}
        </label>
      )}
...
export const NeobrutalismAdapter: PresentationAdapter = {
  id: "neobrutalism",
  className: "a-form-neobrutalism",
  templates: { FieldTemplate },
};

export { FieldTemplate as NeobrutalismFieldTemplate };
